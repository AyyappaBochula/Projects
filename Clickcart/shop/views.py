    ...
    if request.user.is_authenticated:
        ...
        if cart:
            ...
            for cart_item in cart.items.all():
                ...
                cart_items.append({'product': cart_item.product, 'quantity': cart_item.quantity, 'total_price': total_price})
    return render(request, 'cart.html', {'cart_items': cart_items, 'total_amount': total_amount, 'cart_item_count': cart_item_count})
